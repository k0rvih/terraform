...
workerJson = {"Endpoint": {"CommunicationStyle": "Ssh", "AccountId": accid, "Host": publicHostName, "Port": 22, "Fingerprint": fingerprint, "DotNetCorePlatform": dotNetCorePlatform}, "Name": machineName, "WorkerPoolIds": ["WorkerPools-21"]}
